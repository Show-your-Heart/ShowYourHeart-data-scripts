...
{% macro update_external_answers_calc_agg() %}

create index cix_{{ this.table }} on {{ this }} (id_campaign, id_organization, id_method, id_methods_section, id_indicator, id_survey);

CLUSTER {{ this }} USING cix_{{ this.table }};
